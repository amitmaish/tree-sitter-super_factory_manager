LANGUAGE_NAME := tree-sitter-super-factory-manager
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-super_factory_manager
VERSION := 0.1.0
DESCRIPTION := A Minecraft mod that adds a domain-specific language for logistics automation.
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/super-factory-manager '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/super-factory-manager
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/super-factory-manager
